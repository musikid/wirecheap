...
public class Dns {
    ...
    public static Dns create(ByteBuffer bytes) throws NotEnoughBytesException {
        ...
        boolean questionSectionBool = questions >= 1;
    ...
    public String toString() {
        return new StringJoiner(delimiter, prefix, sufix)
                .add(" \t -> Identifier: " + Short.toUnsignedInt(identifier))
                .add(flags.toString().replaceAll("\n", "\n    "))
                .add("Question: " + Short.toUnsignedInt(questions))
                .add("AnswerRRs: " + Short.toUnsignedInt(answerRRs))
                .add("AuthorityRRs: " + Short.toUnsignedInt(authorityRRs))
